...
// Dashboard >>> profile >>> field4
export { default as IconGiftCard } from './dashboard/profile/field4/icon-gift-card'
export { default as IconSauna } from './dashboard/profile/field4/icon-sauna'
export { default as IconSwish } from './dashboard/profile/field4/icon-swish'
export { default as IconParking } from './dashboard/profile/field4/icon-parking'
export { default as IconCashPayment } from './dashboard/profile/field4/icon-cash-payment'
export { default as IconWellnet } from './dashboard/profile/field4/icon-Wellnet'
export { default as IconBath } from './dashboard/profile/field4/icon-bath'
export { default as IconShower } from './dashboard/profile/field4/icon-shower'
export { default as IconWC } from './dashboard/profile/field4/icon-WC'
export { default as IconMiniHealthCare } from './dashboard/profile/field4/icon-mini-health-care'
export { default as IconIndividualRooms } from './dashboard/profile/field4/icon-individual-rooms'
export { default as IconMassageBench } from './dashboard/profile/field4/icon-massage-bench'
export { default as IconActiway } from './dashboard/profile/field4/icon-actiway'
export { default as IconTwoMasseuses } from './dashboard/profile/field4/icon-two-masseuses'
export { default as IconMattress } from './dashboard/profile/field4/icon-mattress'
export { default as IconCardPayment } from './dashboard/profile/field4/icon-card-payment'
export { default as IconWellnessCheck } from './dashboard/profile/field4/icon-wellness-check'

// Dashboard >>> profile >>> field2
export { default as IconUptrend } from './dashboard/profile/field2/icon-uptrend'

// Dashboard >>> profile >>> field7
export { default as IconLocationPlus } from './dashboard/profile/field7/icon-location-plus'
export { default as IconBigPlus } from './dashboard/profile/field7/icon-big-plus'

// Dashboard >>> profile >>> image upload warning modal
export { default as IconCircledExclamationMark } from './dashboard/profile/image-upload-warning-modal/icon-circled-exclamation-mark'
...
export { default as IconPaypal } from './single/payment-methods/icon-paypal'
