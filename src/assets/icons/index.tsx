...
// Dashboard >>> profile
export { default as IconGiftCard } from './dashboard/profile/icon-gift-card'
export { default as IconSauna } from './dashboard/profile/icon-sauna'
export { default as IconSwish } from './dashboard/profile/icon-swish'
export { default as IconParking } from './dashboard/profile/icon-parking'
export { default as IconCashPayment } from './dashboard/profile/icon-cash-payment'
export { default as IconWellnet } from './dashboard/profile/icon-Wellnet'
export { default as IconBath } from './dashboard/profile/icon-bath'
export { default as IconShower } from './dashboard/profile/icon-shower'
export { default as IconWC } from './dashboard/profile/icon-WC'
export { default as IconMiniHealthCare } from './dashboard/profile/icon-mini-health-care'
export { default as IconIndividualRooms } from './dashboard/profile/icon-individual-rooms'
export { default as IconMassageBench } from './dashboard/profile/icon-massage-bench'
export { default as IconActiway } from './dashboard/profile/icon-actiway'
export { default as IconTwoMasseuses } from './dashboard/profile/icon-two-masseuses'
export { default as IconMattress } from './dashboard/profile/icon-mattress'
export { default as IconCardPayment } from './dashboard/profile/icon-card-payment'
export { default as IconWellnessCheck } from './dashboard/profile/icon-wellness-check'
// single
