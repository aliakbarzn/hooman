		...
		<div className='md:w-[440]'>
			<form className='gap-y-6 flex flex-col'>
				...
				<div className='hidden gap-x-2 sm:flex items-start'>
					...
					<label className='max-w-[398px] hover:underline cursor-text font-light text-base' htmlFor='consent'>By registering on the site, I read and approve the rules and regulations. me</label>
				</div>
				{/* submit button */}
				<button
					className='mt-8 sm:mt-0 text-base font-light text-white w-[317.15px] sm:w-[435px] h-14 bg-[#F58882] rounded-[36px]'
				>Register</button>
			</form>
			...
			<div className='mt-7 flex flex-col gap-y-8 items-center'>
				...
				<div className='flex gap-x-4'>
					...
					<div className='flex items-center gap-x-1 sm:gap-x-6 bg-[#FFF4F2] w-[237px] sm:w-[362px] h-14 justify-center rounded-[36px] cursor-pointer'>
						<GoogleIcon />
						<p className='text-base text-[#848483]'>Register with Google</p>
					</div>
					{/* facebook */}
